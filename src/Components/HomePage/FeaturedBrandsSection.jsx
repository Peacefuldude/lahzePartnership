...
function FeaturedBrandsSection() {
    return (
        <div className={"flex flex-col justify-center p-[3em] items-stretch text-center"}>
            ...
            <div className="featuredBrandsSection-description text-[1.2em]">
                <div>
                    ما مفتخریم که با این شرکت کار می کنیم
                </div>
            </div>
            <div className="featuredBrandsSection-brands text-center flex items-center justify-center md:mt-[1.1em]">
