  ...
  return (
    <div className=" hidden header-mobile-menu">
      ...
      <div
        className={`${
          showMenu ? "hidden" : ""
        } header-hamburger-menu-icon cursor-pointer`}
      ...
      >
        <div className="p-4">
          <div
            ...
            className="mb-9 mt-5 text-white font-medium text-[1.3rem] hover:cursor-pointer hover:text-opacity-80 transition-colors duration-200"
          >
            همکاری با ما
          </div>
          <a
            ...
            className="mb-9 block text-white font-medium text-[1.3rem] hover:cursor-pointer hover:text-opacity-80 transition-colors duration-200"
          >
            سوالات متداول
          </a>
          <a
