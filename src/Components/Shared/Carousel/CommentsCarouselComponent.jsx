...
const CommentsCarouselComponent = () => {
    const testimonials = [
        ...
        { id: 2, name: "رستوان چیلی", text: "همکاری با لحظه کارت برای ما تجربه‌ای سریع، حرفه‌ای و فراتر از انتظار بود. تیمی خلاق و مسئولیت‌پذیر که همیشه یک قدم جلوتر فکر می‌کنند.", rating: 5, avatar: "../src/assets/carousel/logo.png" },
        { id: 3, name: "رستوان چیلی", text: "همکاری با لحظه کارت برای ما تجربه‌ای سریع، حرفه‌ای و فراتر از انتظار بود. تیمی خلاق و مسئولیت‌پذیر که همیشه یک قدم جلوتر فکر می‌کنند.", rating: 4, avatar: "../src/assets/carousel/logo.png" },
        { id: 4, name: "رستوان چیلی", text: "همکاری با لحظه کارت برای ما تجربه‌ای سریع، حرفه‌ای و فراتر از انتظار بود. تیمی خلاق و مسئولیت‌پذیر که همیشه یک قدم جلوتر فکر می‌کنند.", rating: 5, avatar: "../src/assets/carousel/logo.png" },
        { id: 5, name: "رستوان چیلی", text: "همکاری با لحظه کارت برای ما تجربه‌ای سریع، حرفه‌ای و فراتر از انتظار بود. تیمی خلاق و مسئولیت‌پذیر که همیشه یک قدم جلوتر فکر می‌کنند.", rating: 5, avatar: "../src/assets/carousel/logo.png" },
        { id: 6, name: "رستوان چیلی", text: "همکاری با لحظه کارت برای ما تجربه‌ای سریع، حرفه‌ای و فراتر از انتظار بود. تیمی خلاق و مسئولیت‌پذیر که همیشه یک قدم جلوتر فکر می‌کنند.", rating: 5, avatar: "../src/assets/carousel/logo.png" },
        { id: 7, name: "رستوان چیلی", text: "همکاری با لحظه کارت برای ما تجربه‌ای سریع، حرفه‌ای و فراتر از انتظار بود. تیمی خلاق و مسئولیت‌پذیر که همیشه یک قدم جلوتر فکر می‌کنند.", rating: 5, avatar: "../src/assets/carousel/logo.png" },
    ];
